...
from blog.widgets import TrixEditorWidget
...
class TrixWidgetTest(TestCase):
    ...
    def test_is_trix_editor_widget(self):
        self.assertIsInstance(self.widget, TrixEditorWidget)
...
class EventAdminTrixTest(TestCase):
    def test_event_admin_uses_trix_widget_for_description(self):
        ...
        self.assertIsInstance(widget, TrixEditorWidget)
